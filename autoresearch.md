...
- Trailing padding was often emitted as its own span even when it matched the colors of the last content span. Merging that padding into the last span reduced span count on the hot path and gave another strong improvement, especially for navigation-heavy workloads.
